---
description: Zuweisen von Berechtigungen für Funktionsbereiche (Master Data Services)
title: Zuweisen von Berechtigungen für Funktionsbereiche
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds

---
title: Dokumentation zu SQL Server-Includedateien
description: Eine Erläuterung der SQL Server-Includedateien für die Versionsverwaltung und Geltungsbereiche
ms.custom: ''
ms.date: 01/19/2019
ms.prod: sql
ms.reviewer: ''

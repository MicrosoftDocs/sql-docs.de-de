...
description: Hier erfahren Sie mehr über die Seite „Optionen“, die sich auf dem AlwaysOn-Dashboard von SQL Server in SQL Server Management Studio befindet.
ms.custom: seodec18
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''

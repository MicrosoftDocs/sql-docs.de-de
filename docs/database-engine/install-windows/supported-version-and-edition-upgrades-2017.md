---
title: Unterstützte Versions- und Editionsupgrades in SQL Server 2017
description: In diesem Artikel finden Sie Informationen zu den unterstützten Versions- und Editionsupgrades für SQL Server 2017.
...
ms.locfileid: "100341802"
---
# <a name="supported-version--edition-upgrades-sql-server-2017"></a>Unterstützte Versions- und Editionsupgrades in SQL Server 2017

[!INCLUDE [SQL Server -Windows Only](../../includes/applies-to-version/sql-windows-only.md)]
  
  Sie können ein Upgrade von [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)], [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)], [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] und [!INCLUDE[sssql15-md](../../includes/sssql16-md.md)] ausführen. In diesem Artikel werden die unterstützten Upgradepfade von diesen [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Versionen sowie die unterstützten Editionsupgrades für [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] aufgeführt.  
  
## <a name="pre-upgrade-checklist"></a>Prüfliste vor dem Upgrade  
  
-   Bevor eine Edition von [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] auf eine andere Edition aktualisiert wird, sollten Sie überprüfen, ob die derzeit verwendete Funktionalität in der Edition, die Ziel des Upgrades ist, unterstützt wird.  
...
-   Versionsübergreifende Instanzen von [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] werden nicht unterstützt. Die Versionsnummern der [!INCLUDE[ssDE](../../includes/ssde-md.md)]-Komponenten innerhalb einer Instanz von [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] müssen identisch sein.  
  
-   [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] ist nur für 64-Bit-Plattformen verfügbar. Ein plattformübergreifendes Upgrade wird nicht unterstützt. Sie können keine 32-Bit-Instanz von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] mit [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Setup auf systemeigenes 64-Bit aktualisieren. Sie können jedoch Datenbanken von einer 32-Bit-Instanz von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]sichern oder trennen und sie in einer Instanz von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (64-Bit) wiederherstellen oder anfügen, wenn die Datenbanken nicht in der Replikation veröffentlicht sind. Sie müssen alle Anmeldenamen und anderen Benutzerobjekte in den Systemdatenbanken „master“, „msdb“ und „model“ wiederherstellen.  
  
-   Sie können während des Upgrades der vorhandenen Instanz von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]keine neuen Funktionen hinzufügen. Nachdem Sie eine Instanz von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] auf [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] aktualisiert haben, können Sie Funktionen mit dem [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)]-Setup hinzufügen. Weitere Informationen finden Sie unter [Hinzufügen von Funktionen zu einer Instanz von SQL Server 40 (Setup)](./add-features-to-an-instance-of-sql-server-setup.md).  
 
-   Failovercluster werden im WOW-Modus nicht unterstützt.  
    
## <a name="upgrades-from-earlier-versions-to-sssql17-md"></a>Upgrades von früheren Versionen auf [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)]  
 
[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] unterstützt ein Upgrade von folgenden Versionen von SQL Server:
...
>  Informationen zum Aktualisieren von Datenbanken aus [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] finden Sie unter [SQL Server 2016-Unterstützung für SQL Server 2005](#SupportFor2005).  
 ...
 In der nachfolgenden Tabelle sind die unterstützten Szenarien für das Upgrade von früheren Versionen von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] auf [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)]aufgeführt.  
...
|[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] SP4 Developer|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Entwickler|  
...
|[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] SP3 Developer|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Entwickler|  
...
|[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] SP2 Developer|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Entwickler <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Web <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise <br/> |  
...
|[!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] Entwickler|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Entwickler <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Web <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise <br/> |  
...
|[!INCLUDE [sssql17-md](../../includes/sssql17-md.md)] Entwickler |[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise | 
...
###  <a name="sssql17-md-support-for-ssversion2005"></a><a name="SupportFor2005"></a> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)]-Unterstützung für [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]  
 In diesem Abschnitt wird die [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] -Unterstützung für [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]erläutert. In [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)]können Sie die folgenden Schritte ausführen:  
  
-   Anfügen einer [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]-Datenbank (MDF-/LDF-Dateien) an eine [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)]-Instanz der Datenbank-Engine.  
  
-   Wiederherstellen einer [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]-Datenbank auf einer [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)]-Instanz der Datenbank-Engine mithilfe einer Sicherung.  
  
-   Sichern eines [!INCLUDE[ssASversion2005](../../includes/ssasversion2005-md.md)]-Cubes und Wiederherstellen in [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)].  
  
Wenn für eine [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]-Datenbank ein Upgrade auf [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] ausgeführt wird, ändern sich der Datenbank-Kompatibilitätsgrad von 90 in 100. (In [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] sind 100, 110, 120, 130 und 140 gültige Werte für den Datenbank-Kompatibilitätsgrad.) In [ALTER DATABASE Kompatibilitätsgrad &#40;Transact-SQL&#41;](../../t-sql/statements/alter-database-transact-sql-compatibility-level.md) wird erläutert, wie sich eine Änderung des Datenbank-Kompatibilitätsgrads auf [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Anwendungen auswirken kann.  
  
Szenarien, die in der Liste nicht aufgeführt sind, werden nicht unterstützt. Das gilt z. B. für:  
  
- Installieren von [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] und [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] auf demselben Computer (parallel).  
  
- Verwenden einer [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] -Instanz als Mitglied der Replikationstopologie, die eine [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] -Instanz umfasst.  
  
- Konfigurieren der Datenbankspiegelung zwischen [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] - und [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] -Instanzen.  
  
- Sichern des Transaktionsprotokolls mit Protokollversand zwischen [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] - und [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] -Instanzen.  
  
- Konfigurieren von Verbindungsservern zwischen [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] - und [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] -Instanzen.  
  
- Verwalten einer [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] -Instanz von [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Management Studio aus.  
  
- Anfügen eines [!INCLUDE[ssASversion2005](../../includes/ssasversion2005-md.md)] -Cubes in [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Management Studio.  
  
- Herstellen einer Verbindung mit [!INCLUDE[ssISversion2005](../../includes/ssisversion2005-md.md)] von [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Management Studio aus.  
  
- Verwalten eines [!INCLUDE[ssISversion2005](../../includes/ssisversion2005-md.md)] -Diensts von [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Management Studio aus.  
...
## <a name="sssql17-md-edition-upgrade"></a>[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Editionsupgrade  
In der folgenden Tabelle sind die unterstützten Szenarien für das Editionsupgrade in [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)]aufgeführt.  
...
|------------------|----------------|  
|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Server+CAL und Core)**|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise |  
|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise Evaluation**|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Server+CAL- oder Core-Lizenz) <br/><br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Entwickler <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Web <br/> <br/> Upgrades von Evaluation (kostenlose Edition) auf eine kostenpflichtige Edition werden für eigenständige Installationen, für gruppierte Installationen jedoch nicht unterstützt. Diese Begrenzung gilt nicht für eigenständige Instanzen, die auf einem Failovercluster von Windows installiert sind, der Mitglied einer Verfügbarkeitsgruppe ist.|  
|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard**|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Server+CAL- oder Core-Lizenz)|  
|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Developer**|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Server+CAL- oder Core-Lizenz) <br/><br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Web <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard|  
|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Web|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Server+CAL- oder Core-Lizenz) <br/><br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard|  
|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Express*|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Server+CAL- oder Core-Lizenz) <br/><br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Entwickler <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard <br/> <br/> [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Web|  
  
 Außerdem können Sie ein Editionsupgrade zwischen [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Server+CAL-Lizenz) und [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Core-Lizenz) ausführen:  
  
|Editionsupgrade von|Editionsupgrade auf|  
|--------------------------|------------------------|  
|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Server+CAL-Lizenz)**|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Core-Lizenz)|  
|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Core-Lizenz)|[!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise (Server+CAL-Lizenz)|  
  
 \* Gilt auch für [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Express with Tools und [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Express with Advanced Services.  
  
 ** Das Ändern der Edition eines [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] -Failoverclusters ist nur beschränkt möglich. Die folgenden Szenarien werden bei [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] -Failoverclustern nicht unterstützt:  
  
-   [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Enterprise in [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Developer, Standard oder Evaluation.  
  
-   [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Developer in [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard oder Evaluation.  
  
-   [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard in [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Evaluation.  
  
-   [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Evaluation in [!INCLUDE[sssql17-md](../../includes/sssql17-md.md)] Standard.  

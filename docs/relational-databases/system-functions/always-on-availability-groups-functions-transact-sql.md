---
description: Funktionen der Always on-Verfügbarkeits Gruppen (Transact-SQL)
title: Funktionen der Always on-Verfügbarkeits Gruppen (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
ms.locfileid: "100344279"
---
# <a name="always-on-availability-groups-functions-transact-sql"></a>Funktionen der Always on-Verfügbarkeits Gruppen (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] stellt die folgenden Always on Funktionen für Verfügbarkeits Gruppen bereit.  

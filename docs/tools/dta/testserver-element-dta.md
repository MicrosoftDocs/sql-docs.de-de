...
description: Im Hilfsprogramm „DTA“ gibt das Element „TestServer“ den Testserver an, der beim Optimieren eines Produktionsservers verwendet werden soll.
ms.prod: sql

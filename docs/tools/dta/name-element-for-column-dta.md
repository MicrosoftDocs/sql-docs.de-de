---
title: Name-Element für Spalte (DTA)
description: Im dta-Hilfsprogramm gibt das Name-Element für „Spalte“ den Namen einer Indexspalte in einer benutzerdefinierten Konfiguration an.
ms.prod: sql

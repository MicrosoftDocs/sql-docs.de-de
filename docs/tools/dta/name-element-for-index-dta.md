---
title: Name-Element für Index (DTA)
description: Im dta-Hilfsprogramm gibt das Name-Element für Index den Namen eines Index in der benutzerdefinierten Konfiguration an.
ms.prod: sql

...
description: Mithilfe der folgenden C++-Beispielanwendung wird gezeigt, wie Sie mit den ODBC-APIs eine Verbindung zu einer SQL-Datenbank herstellen und darauf zugreifen.
ms.custom: ''
ms.date: 06/19/2020
ms.prod: sql
